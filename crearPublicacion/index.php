...
<head>
    ...
    <script src="../inicio/jquery-3.6.0.js"></script>
...
<!-- DIV CONTENIDO -->
    <div class="fila" id="contenidoGen">
        <div id="bordeContenido">
            ...
            <div id="publicacion">
                <p id="titulo">Crear publicación</p>
                <input type="" placeholder="Escribe aquí el título" id="tituloPubli">
                <div id="textArea"></div>
                <!-- <textarea name="d" id="textArea" cols="30" rows="10"></textarea> -->
            </div>
            ...
            <div id="barraContenido">
                ...
                <form action="../../form-result.php" id="formcateg" target="_blank">
                    ...
                    <input type="submit" id="aceptarCateg" value="Enviar">
